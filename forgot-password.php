...
$con="update tblusers set Password=:newpassword where id=:usid";
$chngpwd1 = $dbh->prepare($con);
$chngpwd1-> bindParam(':usid', $usid, PDO::PARAM_STR);
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>CSC506 | Password Recovery</title>
        ...
        <div class="mn-content fixed-sidebar">
                ...
                <nav class="cyan darken-1">
                    <div class="nav-wrapper row">
                        ...
                        <div class="header-title col s3">      
                            <span class="chapter-title">CSC506 | Group Assignment</span>
                        </div>
            ...
            <aside id="slide-out" class="side-nav white fixed">
                ...
                <ul class="sidebar-menu collapsible collapsible-accordion" data-collapsible="accordion" style="">
                    ...
                    <li class="no-padding"><a class="waves-effect waves-grey" href="forgot-password.php"><i class="material-icons"></i>User Password Recovery</a></li>
          ...
          <div class="footer">
            ...
            <main class="mn-inner">
                <div class="row">
                    <div class="col s12">
                        <div class="page-title"><h4>User Password Recovery</h4></div>
                                       ...
                                       <div class="row">
                                           <form class="col s12" name="signin" method="post">
                                               <div class="input-field col s12">
                                                   <input id="usid" type="text" name="usid" class="validate" autocomplete="off" required >
...
$usid=$_POST['usid'];
$email=$_POST['emailid'];
$sql ="SELECT id FROM tblusers WHERE EmailId=:email and UsId=:usid";
