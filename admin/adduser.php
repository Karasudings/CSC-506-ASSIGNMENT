...
$sql="INSERT INTO tblusers(UsId,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:usid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
function valid()
{
if(document.addus.password.value!= document.addus.confirmpassword.value)
{
alert("Passwords do not match  !!");
document.addus.confirmpassword.focus();
return false;
}
return true;
}
...
<script>
function checkAvailabilityUsid() {
$("#loaderIcon").show();
jQuery.ajax({
url: "check_availability.php",
data:'uscode='+$("#uscode").val(),
type: "POST",
success:function(data){
$("#usid-availability").html(data);
$("#loaderIcon").hide();
},
error:function (){}
});
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="addus">
                                    <div>
                                        <h3>User Info</h3>
                                        <section>
...
<label for="uscode">User Code(Must be unique)</label>
<input  name="uscode" id="uscode" onBlur="checkAvailabilityUsid()" type="text" autocomplete="off" required>
<span id="usid-availability" style="font-size:12px;"></span> 
</div>
