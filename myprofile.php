...
if(strlen($_SESSION['uslogin'])==0)
    {   
header('location:index.php');
}
else{
$uid=$_SESSION['uslogin'];
...
$sql="update tblusers set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:uid";
                    ...
                    <div class="col s12 m12 l12">
                        <div class="card">
                            <div class="card-content">
                                <form id="example-form" method="post" name="updatus">
                                    <div>
...
<label for="uscode">User Code</label>
<input  name="uscode" id="uscode" value="<?php echo htmlentities($result->UsId);?>" type="text" autocomplete="off" readonly required>
...
<button type="submit" name="update"  id="update" class="waves-effect waves-light btn indigo m-b-xs">UPDATE</button>
		...
		<script src="../assets/js/pages/dashboard-popup.js"></script>
